...
if ($_FILES['uploadedfile']['tmp_name'] != "") {
    ...
    // Set Max file size limit to somewhere around 2 mb
    $maxfilesize = 2000000;
    ...
    // Check file extension to see if it is .jpg or .gif, if not exit and tell them why
        ...
        // Upload the file
        if (move_uploaded_file($_FILES['uploadedfile']['tmp_name'], "photos/$uid/".$newname)) {
...
<title>Edit Your profile pic</title>
    ...
    <td width="20%"><img src="logo.png" alt="my logo" /></td>
     ...
     <table border="2" align="center" cellpadding="5" cellspacing="5">
      <form action="edit_pic.php" method="post" enctype="multipart/form-data" name="form" id="form" onsubmit="return validate_form ( );">
         <tr>
           <td colspan="2"><img src="memberFiles/<?php echo "$uid"; ?>/pic1.jpg" alt="Ad" width="150" /></td>
         </tr>
		 <tr>
